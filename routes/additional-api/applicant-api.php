...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::post('/applicant/enrollment/tuition-fees', [ApplicantEnrollmentController::class, 'enrollment_payment_mode']);
    Route::post('/applicant/enrollment/enrollment-payment', [ApplicantEnrollmentController::class, 'enrollment_payment']);
