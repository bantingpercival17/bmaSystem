...
Route::prefix('teacher')->group(function () {
    ...
    Route::get('/subjects', [TeacherController::class, 'index']); // Subject View
    Route::get('/subjects/grading-sheet', [TeacherController::class, 'subject_grading_view']); // Subject Grading Sheet View
    Route::post('/subjects/grade-submission', [TeacherController::class, 'subject_grade_submission']); // Subject Submission
    Route::get('/previous-subjects', [TeacherController::class, 'subject_view']); // Previous Subjects Per Academic Year
