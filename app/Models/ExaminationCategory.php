...
class ExaminationCategory extends Model
{
    ...
    {
        return $this->hasMany(ExaminationQuestion::class, 'category_id')->select('id', 'category_id', 'question', 'image_path')->with('choices_v3')->where('is_removed', false)->inRandomOrder();
    }
}
