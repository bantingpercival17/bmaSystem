...
class ApplicantMedicalList implements FromCollection,  WithMapping, WithHeadings, WithEvents, WithTitle, ShouldAutoSize
{
    ...
    public function map($_data): array
    {
        ...
        return [
            $_data->applicant->account->medical_appointment ? $_data->applicant->account->medical_appointment->appointment_date : 'NO APPOINTMENT',
            $_data->applicant->last_name,
            $_data->applicant->first_name,
            $_data->applicant->middle_name,
