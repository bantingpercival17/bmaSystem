            ...
            <table class="form-rg-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-fill-in"> <b>{{ strtoupper($_student->extention_name) }}</b></td>
                    ...
                    <tr class="text-center">
                        ...
                        <td><small>EXTENSION NAME</small></td>
                        <td colspan="1"></td>
                </tbody>
            </table>
            <table class="form-rg-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <p class="checkbox-container">
                                <label><input class="checkbox-input" type="checkbox" {{ $_parent ? ($_parent->father_educational_attainment == $_education ? 'checked' : '') : '' }} />{{ $_education }}</label>
                            </p>
                            @endforeach
                        </td>
                        <td>
                            ...
                            @foreach ($_educational_attainment as $_key => $_education)
                            <p class="checkbox-container">
                                <label><input class="checkbox-input" type="checkbox" {{ $_parent ? ($_parent->mother_educational_attainment == $_education ? 'checked' : '') : '' }} />{{ $_education }}</label>
                            </p>
                            @endforeach
                        </td>
                        <td>
                            ...
                            @foreach ($_educational_attainment as $_key => $_education)
                            <p class="checkbox-container">
                                <label><input class="checkbox-input" type="checkbox" {{ $_parent ? ($_parent->guardian_educational_attainment == $_education ? 'checked' : '') : '' }} />{{ $_education }}</label>
                            </p>
                            @endforeach
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <p class="checkbox-container">
                                <label>
                                    <input class="checkbox-input" type="checkbox" {{ $_parent ? ($_parent->father_employment_status == $_status ? 'checked' : '') : '' }} />
                                    {{ $_status }}
                                </label>
                            </p>
                            @endforeach
                        ...
                        <td>
                            ...
                            <p class="checkbox-container">
                                <label>
                                    <input class="checkbox-input" type="checkbox" {{ $_parent ? ($_parent->mother_employment_status == $_status ? 'checked' : '') : '' }} />
                                    {{ $_status }}
                                </label>
                            </p>
                            @endforeach
                        ...
                        <td>
                            ...
                            <p class="checkbox-container">
                                <label>
                                    <input class="checkbox-input" type="checkbox" {{ $_parent ? ($_parent->guardian_employment_status == $_status ? 'checked' : '') : '' }} />
                                    {{ $_status }}
                                </label>
                            </p>
                            @endforeach
                    ...
                    <tr>
                        <td>
                            ...
                            <p class="checkbox-container">
                                <label>
                                    <input class="checkbox-input" type="checkbox" {{ $_parent ? ($_parent->father_working_arrangement == $_data ? 'checked' : '') : '' }} />
                                    {{ $_data }}
                                </label>
                            </p>
                            @endforeach
                        ...
                        <td>
                            ...
                            <p class="checkbox-container">
                                <label>
                                    <input class="checkbox-input" type="checkbox" {{ $_parent ? ($_parent->mother_working_arrangement == $_data ? 'checked' : '') : '' }} />
                                    {{ $_data }}
                                </label>
                            </p>
                            @endforeach
                        ...
                        <td>
                            ...
                            <p class="checkbox-container">
                                <label>
                                    <input class="checkbox-input" type="checkbox" {{ $_parent ? ($_parent->guardian_working_arrangement == $_data ? 'checked' : '') : '' }} />
                                    {{ $_data }}
                                </label>
                            </p>
                            @endforeach
                    ...
                    <tr>
                        <td colspan="">
                            ...
                            <p class="checkbox-container">
                                <label>
                                    <input class="checkbox-input" type="checkbox" {{ $_parent ? ($_parent->household_income == $_data ? 'checked' : '') : '' }} />
                                    {{ $_data }}
                                </label>
                            </p>
                            @endforeach
                        ...
                        <td colspan="" colspan="1" valign="top">
                            ...
                            <p class="checkbox-container">
                                <label>
                                    <input class="checkbox-input" type="checkbox" {{ $_parent ? ($_parent->dswd_listahan == $_data ? 'checked' : '') : '' }} />
                                    {{ $_data }}
                                </label>
                            </p>
                            @endforeach
                        ...
                        <td colspan="1" colspan="1" valign="top">
                            ...
                            <p class="checkbox-container">
                                <label>
                                    <input class="checkbox-input" type="checkbox" {{ $_parent ? ($_parent->homeownership == $_data ? 'checked' : '') : '' }} />
                                    {{ $_data }}
                                </label>
                            </p>
                            @endforeach
                    ...
                    <tr>
                        <td colspan="3" colspan="1" valign="top">
                            ...
                            <label class="checkbox-container">
                                <input class="checkbox-input" type="checkbox" {{ $_parent ? ($_parent->car_ownership == $_data ? 'checked' : '') : '' }} />
                                {{ $_data }}
                            </label>
                            @endforeach
                        </td>
            ...
            <table class="form-rg-table">
                <tr>
                    <td colspan="1">
                        ...
                        <p class="checkbox-container">
                            <label>
                                <input class="checkbox-input" type="checkbox" {{ in_array($_data, $_device_1) ? 'checked' : '' }} />
                                {{ $_data }}
                            </label>
                        </p>
                        @endforeach
                    ...
                    <td colspan="1" valign="top">
                        ...
                        <div>
                            <p class="checkbox-container">
                                <label>
                                    <input class="checkbox-input" type="checkbox" {{ $_parent ? ($_parent->available_connection == $_data ? 'checked' : '') : '' }} />
                                    {{ $_data }}
                                </label>
                            </p>
                        </div>
                    ...
                    <td colspan="1" valign="top">
                        ...
                        <p class="checkbox-container">
                            <label>
                                <input class="checkbox-input" type="checkbox" {{ in_array($_data, $_array) ? 'checked' : '' }} />
                                {{ $_data }}
                            </label>
                        </p>
                        @endforeach
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="{{ $_enrollment_assessment->bridging_program == 'with' ? 2 : 1 }}">
                        ...
                        <b>{{ strtoupper($_student->last_name . ', ' . $_student->first_name . ' ' . $_student->middle_name . ' '. $_student->extention_name) }}</b>
                    </td>
