...
<main class="content">
    <h5 class="text-center ">ASSESSMENT FOR INCOMING 1/C -
        {{ $_data->enrollment_assessment->course_id == 2 ? 'DECK CADET' : ' ENGINE CADET' }}
    </h5>
            ...
            <table class="table-content">
                <tbody>
                    <tr style="text-align: center">
                        <td><i><b>2M John Paul Flores</b></i></td>
