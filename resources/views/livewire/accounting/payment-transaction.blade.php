...
<div>
        ...
        <div class="col-md-8">
            ...
            <div class="card mb-2 shadow">
                <div class="row no-gutters">
                    <div class="col-md-3">
                        <img src="{{ $profile ? $profile->profile_picture() : 'http://bma.edu.ph/img/student-picture/midship-man.jpg' }}" class="card-img" alt="#">
                    </div>
                    <div class="col-md ps-0">
                        <div class="card-body p-3 me-2">
                            <label for="" class="fw-bolder text-primary h4">{{ $profile ? strtoupper($profile->last_name . ', ' . $profile->first_name) : 'MIDSHIPMAN NAME' }}</label>
                            <p class="mb-0">
                ...
                <div class="dropdown mt-3 mb-2 w-100">
                    <a class=" dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        ...
                        <span>
                            ...
                            <span class="text-primary fw-bolder">{{ $academicData->semester . ' | ' . $academicData->school_year }}</span>
                        </span>
                        @endif
                    </a>
                    ...
                    <ul class="dropdown-menu w-100" data-popper-placement="bottom-start">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('accounting.payment-transactions-v2') }}?student={{ base64_encode($profile->id) }}{{ '&_academic=' . base64_encode($item->academic_id) }}">
            ...
            <table class="nav nav-underline bg-soft-primary p-0 text-center" aria-label="Secondary navigation">
                <thead class="d-flex">
                    <tr>
                        <td class="nav-link  {{ $activeCard == 'overview' ? 'active' : 'text-muted' }} " wire:click="swtchTab('overview')">OVERVIEW</td>
                    </tr>
                    <tr>
                        <td class="nav-link  {{ $activeCard == 'transaction' ? 'active' : 'text-muted' }} " wire:click="swtchTab('transaction')">TRANSACTION</td>
                    </tr>
                    <tr>
                        <td class="nav-link  {{ $activeCard == 'history' ? 'active' : 'text-muted' }} " wire:click="swtchTab('history')">PAYMENT HISTORY</td>
                    </tr>
                    <tr>

                        <td class="nav-link  {{ $activeCard == 'online-payment' ? 'active' : 'text-muted' }} " wire:click="swtchTab('online-payment')">ONLINE PAYMENT</td>
            ...
            <div class="card mt-3 shadow mb-2">
                <div class="card-body">
                    ...
                    <div class="float-end">
                        <a href="{{ route('accounting.assessments-v2') }}?student={{ base64_encode($profile->id) }}&reassessment=true{{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}" class="badge bg-secondary me-2"> <small>RE-ASSESSMENT</small></a>
                        <a href="{{ route('accounting.student-card') }}?student={{ base64_encode($profile->id) }}" target="_blank" class="badge bg-info"><small>STUDENT CARD</small></a>
                    </div>
                    <div class=" row mt-2">
                        <div class="col-md-4">
                    ...
                    <span class="badge bg-primary float-end" data-bs-toggle="modal" data-bs-target=".view-modal">ADD
                            ...
                            <div class="form-group">
                                ...
                                <div class="float-end">
                                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <small>
                                            <a class="badge bg-secondary" wire:click="addTransaction('{{ $additionalFees->fee_details->particular->particular_name }}','additional','{{ base64_encode($additionalFees->id) }}')">ADD
                                                TRANSACTION</a>
                                        </small>
                                        <small>
                                            @if (!$additionalFees->fee_total_paid())
                                            <a class="badge bg-danger" wire:click="removeFee('{{ $additionalFees->id }}')">REMOVE
                                                FEE</a>
                                            @endif
                                        </small>
                                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
                        ...
                        <div>
                            ...
                            <a href="{{ route('accounting.print-reciept') }}?reciept={{ base64_encode($_payment->id) }}" target="_blank">
                                <h5><span class="text-primary fw-bolder">{{ $_payment->remarks }}</span>
                                </h5>
                            </a>
                        ...
                        <div>
                            ...
                            <h5><span class="text-secondary fw-bolder">{{ number_format($_payment->payment_amount, 2) }}</span>
                            </h5>
                        </div>
                        <div>
                            <small>OR NUMBER: </small> <br>
                            <h5>
                                <a href="{{ route('accounting.print-or-reciept') }}?orNumber={{ base64_encode($_payment->or_number) }}" target="_blank">
                                    {{ $_payment->or_number }}
                                </a>
                            </h5>
                            <a href="{{ route('accounting.print-or-reciept') }}?orNumber={{ base64_encode($_payment->or_number) }}&printer=canon" target="_blank" class="badge bg-primary">CANON</a>
                            <a href="{{ route('accounting.print-or-reciept') }}?orNumber={{ base64_encode($_payment->or_number) }}&printer=epson" target="_blank" class="badge bg-info">EPSON</a>
                        </div>
                        <div>
                            ...
                            @endif
                            @else
                            <button class="btn btn-danger btn-sm btn-form-void w-100 mt-2" wire:click="dialogBox('{{ $_payment->id }}')">
                                VOID</button>
                            @endif
                        </div>
                    </div>
                    <p class="mb-0">
                        ...
                        <small>{{ $_payment->created_at->format('F, d Y h:m:s A') }}</small>
                    </p>
                    @endforeach
                    @else
                    <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
            ...
            <div class="card mt-3 shadow mb-2">
                ...
                <div class="card-body p-2 ps-4 pe-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div>
                            <small>AMOUNT: </small> <br>
                            <span class="text-secondary fw-bolder">{{ number_format($item->amount_paid, 2) }}</span>
                        </div>
                        <div>
                            <small>TRANSACTION TYPE</small> <br>
                            <span class="text-secondary fw-bolder">{{ ucwords(str_replace('_', ' ', $item->transaction_type)) }}</span>
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div>
                            ...
                            <span class="text-secondary fw-bolder">{{ $item->created_at->format('d, F Y') }}</span>
                        </div>
                        <div>
                            <small>PROOF OF PAYMENT: </small> <br>
                            <a class="badge bg-primary btn-form-document w-100 mt-2" data-bs-toggle="modal" data-bs-target=".document-view-modal" data-document-url="{{ $item->reciept_attach_path }}">
                                VIEW</a>
                        </div>
                        <div>
                            ...
                            @endif
                            @else
                            <a class="badge bg-primary w-100 mt-2" wire:click="approvedPayment('{{ base64_encode($item->id) }}')">
                                APPROVED PAYMENT</a>
                            <br>
                            <a class="badge bg-danger w-100 mt-2" wire:click="disapprovedDialogBox('{{ base64_encode($item->id) }}')">
                    ...
                    <form wire:submit.prevent="paymentTransaction">
                        <div class="row">
                            <div class="col-md">
                                ...
                                @if ($transactionStatus == 'tuition-fee')
                                <select wire:model="transactionRemarks" class="form-select form-select-sm border border-primary">
                                ...
                                @else
                                <input type="text" wire:model="transactionRemarks" class="form-control form-control-sm border border-primary">
                                @endif

                            </div>
                            <div class="col-md">
                                <small class="text-muted">PAYMENT METHOD:</small>
                                <select wire:model="transactionPaymentMethod" class="form-select form-select-sm border border-primary">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" wire:model="transactionOrNumber" class="form-control form-control-sm border border-primary" placeholder="0000">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" wire:model="transactionDate" class="form-control form-control-sm border border-primary">
                            </div>
                            <div class="col-md-4">
                                <small class="text-muted">AMOUNT:</small>
                                <input type="text" wire:model="transactionAmount" class="form-control form-control-sm border border-primary" placeholder="{{ count($paymentAssessment->payment_transaction) > 0 ? number_format($paymentAssessment->monthly_payment, 2) : number_format($paymentAssessment->upon_enrollment) }}">
                        ...
                        <div class="row">
                            <div class="col-md">
                                ...
                                <select wire:model="transactionVoucher" class="form-select form-select-sm border border-primary">
                            ...
                            <div class="col-md">
                                ...
                                <input type="text" wire:model="penaltyAmount" class="form-control form-control-sm border border-primary" placeholder="0.00">
                            </div>
                            <div class=" mt-4">
        ...
        <div class="col-md-4">
            <form>
                ...
                <div class="form-group search-input">
                    <input type="search" class="form-control border border-primary" placeholder="Search..." wire:model="inputStudent">
                </div>
            ...
            <div class="student-list">
                ...
                <a href="{{ route('accounting.payment-transactions-v2') }}?student={{ base64_encode($item->id) }}{{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}">
                    <div class="card mb-2 shadow shadow-info">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <img src="{{ $item ? $item->profile_picture() : 'http://bma.edu.ph/img/student-picture/midship-man.jpg' }}" class="avatar-100 rounded card-img" alt="student-image">
                            </div>
                            <div class="col-md p-1">
                                <div class="card-body p-2">
                                    <small class="text-primary fw-bolder">{{ strtoupper($item->last_name . ', ' . $item->first_name) }}</small>
                                    <br>
                                    <small class="badge {{ $item->enrollment_assessment ? $item->enrollment_assessment->color_course() : 'bg-secondary' }} ">{{ $item->enrollment_assessment ? $item->enrollment_assessment->course->course_code : '-' }}</small>
                                    -
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-primary" wire:click="addFees({{ $item->id }})" data-bs-dismiss="modal" aria-label="Close">ADD</button>
                                </td>
                            </tr>
                            @empty
                            <tr>
    ...
    <div class="modal fade document-view-modal" id="document-view-modal" tabindex="-1" role="dialog" aria-hidden="true">
