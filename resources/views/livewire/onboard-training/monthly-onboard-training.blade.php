@php
    $pageTitle = 'Monthly OBT Performance Monitoring';
        ...
        <div class="col-md-4">
            ...
            <div class="student-list">
                @forelse ($studentLists as $item)
                    <a
                        href="{{ route('onboard.shipboard-monitoring') }}?student={{ base64_encode($item->id) }}{{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}">
