...
<div>
    <div class="row">
        <div class="col-lg-8">
            ...
            <a href="{{route('employee.view').'?employee='.base64_encode($employee->id)}}">
                <div class="card mb-2 shadow mb-3">
                    <div class="row no-gutters">
                        <div class="col-md-3">
                            <img src="{{ $employee ? asset($employee->profile_picture()) : asset('/assets/img/staff/avatar.png') }}" class="card-img" alt="#">
                        </div>
                        <div class="col-md ps-0">
                            <div class="card-body p-3 me-2">
                                <label for="" class="fw-bolder text-primary h4">{{ $employee ? strtoupper($employee->last_name . ', ' . $employee->first_name) : 'EMPLOYEE NAME' }}</label>
                                <p class="mb-0">
        ...
        <div class="col-lg-4">
            <form action="" method="get" class="form-group mt-3">
                ...
                <input type="text" class="form-control border border-primary form-control-sm" wire:model="searchInput">
                ...
                <div class="form-group">
                    ...
                    <select name="" id="" wire:model="searchSelect" class="form-select form-select-sm border border-primary">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control form-control-sn border border-primary" wire:model="searchDate">
                </div>
            </form>
            <div class="form mb-5">
                ...
                <div class="">
                    <form action="{{ route('accounting.employee-attendance-v2') }}" target="_blank" method="get">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control form-control-sm border border-primary" name="start_date" required="">
                        </div>
                        <div class="form-group">
                            <small class="text-muted">END DATE</small>
                            <input type="date" class="form-control form-control-sm border border-primary" name="end_date" required="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="department" id="" class="form-select form-select-sm border border-primary">
