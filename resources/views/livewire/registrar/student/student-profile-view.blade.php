        ...
        <div class="col-md-8">
            ...
            <nav class="nav nav-underline bg-soft-primary pb-0 text-center" aria-label="Secondary navigation">
                ...
                <div class="d-flex" id="head-check">
                    <a class="nav-link {{ $activeCard == 'profile' || !$activeCard ? 'active' : 'text-muted' }}">PROFILE</a>
            ...
            <div class="mt-4">
                @if ($activeCard == 'profile')
                    @include('livewire.registrar.student.profile-components.information')
                @endif
            </div>
        </div>
        <div class="col-md-4">
            ...
            <div class="student-list">
                ...
                <a href="{{ route('student.view') }}?student={{ base64_encode($item->id) }}{{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}">
