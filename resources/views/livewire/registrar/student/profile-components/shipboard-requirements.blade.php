<div class="card">
    ...
    <div class="card-body p-3">
        ...
        <div class="document-form">
            <div class="form-group">
                ...
                <small class="badge bg-primary btn-form-document float-end" data-bs-toggle="modal" data-bs-target=".document-view-modal" wire:click="showDocuments('{{ json_decode($requirement->file_links) }}')" title="" data-bs-original-title="View Image">
    ...
    <div class="fixed inset-0 flex items-center justify-center z-50">
        <div class="modal fade show" style="display: block;   background-color: rgb(0 0 0 / 77%);
            width: 100%;
            height: 100%;">
