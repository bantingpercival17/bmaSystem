<div class="card">
    ...
    <div class="card-body p-3">
        @foreach ($document_requirements as $requirement)
            <div class="form-group">
                <span class="fw-bolder text-info">{{ strtoupper($requirement->document_name) }}</span> <br>
                <span class="badge bg-warning">NO DOCUMENT UPLOAD</span>
                {{--  <small class="badge bg-primary btn-form-document float-left" data-bs-toggle="modal"
                    data-bs-target=".document-view-modal" data-document-url="{{ $requirement->file_path }}" title=""
