    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="form-content mb-2">
                ...
                <a href="{{ route('enrollment.withdrawn-list') }}{{ request()->input('_academic') ? '?_academic=' . request()->input('_academic') : '' }}"
                    class="badge bg-primary w-100">{{ strtoupper('List of Withdrawn & Dropped') }}</a>
            </div>
            <div class="row">
                <div class="col-12">
            ...
            <div class="">
                ...
                <a href="{{ route('enrollment.enrolled-list-report') }}?_report=excel-report-2&cancellation=0{{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}"
                    class="badge bg-primary w-100">TOTAL ENROLLED</a> <br>
                <a href="{{ route('enrollment.enrolled-list-report') }}?_report=excel-report-2&cancellation=1{{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}"
                    class="badge bg-primary w-100">TOTAL REMAINING ENROLLED</a> <br>
