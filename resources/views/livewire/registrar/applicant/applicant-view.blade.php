                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-8 col-md-12">
                                    ...
                                    <a href="{{ route('applicant.profile-view') }}?_applicant={{ base64_encode($data->id) }}&_academic={{ $this->academic }}" class="text-primary fw-bolder h2">
                                ...
                                <div class="col-lg-4 col-md-12">
                                    ...
                                    <div class="form-view">
                                        ...
                                        <small class="badge bg-info">{{ $data->applicant_examination->updated_at->format('F d, Y') }}</small>
                                        <div class="row">
                                            <div class="col-md">
                                    ...
                                    <a href="{{ route('applicant.orientation-attended') }}?applicant={{ $data->id }}" class="btn btn-primary btn-sm w-100 mt-2">Present Participant</a>
                                    ...
                                    <label class="badge bg-info" role="button" data-bs-toggle="popover" data-trigger="focus" title="Upload Date: {{ $data->payment->created_at->format('F d,Y') }}">
                                        FOR VERIFICATION
                                    </label>
                                    @else
                                    <label class="badge bg-danger" role="button" data-bs-toggle="popover" data-trigger="focus" title="Upload Date: {{ $data->payment->created_at->format('F d, Y') }}, VERIFICATION DATE: {{ $data->payment->updated_at->format('F d, Y') }}">
                                        DISAPPROVED PAYMENT
                                    </label>
                                    ...
                                    <a href="{{ route('applicant-removed') }}?_applicant={{ base64_encode($data->id) }}" class="btn btn-sm btn-outline-primary w-100 mt-2">REMOVE
                                    </a>
                                    @endif
                        ...
                        <div class="card-footer">
                            ...
                            <form action="{{ route('applicant.orientation-scheduled') }}" method="post">
                                @csrf
                                <input type="hidden" name="applicant" value="{{ base64_encode($data->id) }}">
                                <div class="row">
                                    <div class="col-md">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md">
                                        ...
                                        <label for="" class="text-info fw-bolder">{{ strtoupper($data->schedule_orientation->category) }}
                                            ORIENTATION</label>
                                    </div>
                                    <div class="col-md">
                                        <small class="text-muted fw-bolder">DATE</small><br>
                                        <label for="" class="text-info fw-bolder">{{ $data->schedule_orientation->schedule_date }}</label>
                                    </div>
                                    <div class="col-md">
                                        <small class="text-muted fw-bolder">TIME</small><br>
                                        <label for="" class="text-info fw-bolder">{{ $data->schedule_orientation->schedule_time }}</label>
                                    </div>
                                </div>
                            </div>
                            <form action="{{ route('applicant.orientation-scheduled') }}" method="post">
            ...
            <div class="col-lg-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <select class="form-select border border-primary" wire:model="selectCategories" wire:change="">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group  ">
                            <select wire:model="selectCourse" class="form-select border border-primary" wire:change="categoryCourse">
                    ...
                    <div class="col-md-12">
                        ...
                        <button onclick="payment_notification({{ $dataLists }})" class="btn btn-primary btn-sm w-100 btn-notification">SEND
                            NOTIFICATION</button>
                    </div>
                    @endif
                    ...
                    <div class="col-md-12">
                        ...
                        <button onclick="notification_v2({{ $dataLists }})" class="btn btn-primary btn-sm w-100 btn-notification">SEND
                            NOTIFICATION</button>
                    </div>
                    @endif
                    @if ($selectCategories == 'passed')
                    <div class="col-md-12">
                        <small class="text-primary"><b>MEDICAL ORIENTATION NOTIFICATION</b></small>
                        <a href="{{route('applicant.entrance-examination-result')}}" class="btn btn-sm btn-primary w-100">OPEN RESULTS</a>
                    </div>
                    @endif
                </div>
