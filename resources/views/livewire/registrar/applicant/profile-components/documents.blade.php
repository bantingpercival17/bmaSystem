<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('applicant.applicant-not-qualified') }}?applicant={{ base64_encode($profile->id) }}" class="badge bg-primary">Not Qualified</a>
        @endif
            ...
            <div class="col-md-12">
                ...
                <form class="row" action="{{ route('document-verification') }}">
                    ...
                    <div class="col-md-8">
                        ...
                        <select name="_comment" required class="form-select form-select-sm border border-primary">
                    ...
                    <div class="col-md">
                        <a href="{{ route('document-verification') }}?_document={{ base64_encode($document->id) }}&_verification_status=1" class="mt-2 btn btn-outline-primary btn-sm rounded-pill " data-bs-toggle="tooltip" title="" data-bs-original-title="Approved Document">
                        ...
                        <a class="btn btn-outline-info btn-sm rounded-pill btn-form-document mt-2" data-bs-toggle="modal" data-bs-target=".document-view-modal" data-bs-toggle="tooltip" title="" data-bs-original-title="View Image" data-document-url="{{ json_decode($document->file_links)[0] }}">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="row mt-2">
                    <div class="col-md-8">
                        ...
                        <span>
                            ...
                            <span role="button" data-bs-toggle="popover" data-trigger="focus" class="fw-bolder" title="APPROVED DETAILS" data-bs-content="Approved By: {{ $document->staff ? $document->staff->user->name : '-' }} Approved Date: {{ $document->updated_at->format('F d,Y') }}">{{ $document->updated_at->format('F d,Y') }}</span>
                        </span>
                    </div>
                    <div class="col-md">
                        <a class="btn btn-outline-info btn-sm rounded-pill btn-form-document mt-2" data-bs-toggle="modal" data-bs-target=".document-view-modal" data-bs-toggle="tooltip" title="" data-bs-original-title="View Image" data-document-url="{{ json_decode($document->file_links)[0] }}">
                ...
                <div class="row mt-2">
                    <div class="col-md-8">
                        ...
                        <span>
                            <small>REMARKS: </small>
                            <span role="button" data-bs-toggle="popover" data-trigger="focus" class="fw-bolder" title="APPROVED DETAILS" data-bs-content="Approved By: {{ $document->staff ? $document->staff->user->name : '-' }} Approved Date: {{ $document->updated_at->format('F d,Y') }}">{{ $document->feedback }}</span>
                        </span>
                    </div>
                    <div class="col-md">
                        <a class="btn btn-outline-info btn-sm rounded-pill btn-form-document mt-2" data-bs-toggle="modal" data-bs-target=".document-view-modal" data-bs-toggle="tooltip" title="" data-bs-original-title="View Image" data-document-url="{{ json_decode($document->file_links)[0] }}">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md">
                                ...
                                <small class="badge bg-info">{{ $sent->staff->first_name . ' ' . $sent->staff->last_name }}</small>
                            </div>
                            <div class="col-md">
                                <small class="text-muted fw-bolder">DATE:</small>
                                <small class="badge bg-info">{{ $sent->updated_at->format('F d, Y') }}</small>
                            </div>
                        </div>
                        @endif
                    </div>
                    <div class="col-md">
                        <a class="btn btn-outline-warning btn-sm rounded-pill mt-2" href="{{ route('document-notification') }}?_applicant={{ base64_encode($profile->id) }}&document={{ $item->id }}" data-bs-toggle="tooltip" title="" data-bs-original-title="Send a Notification">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="modal fade document-view-modal" id="document-view-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <iframe id="my-iframe" class="iframe-container form-view iframe-placeholder" src="" width="100%" height="700px">
            </iframe>
        </div>
    </div>
</div>