                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <span>
                                            ...
                                            <span role="button" data-bs-toggle="popover" data-trigger="focus" class="fw-bolder"
                                                ...
                                                data-bs-content="Approved By: {{ $document->staff ? $document->staff->user->name : '-' }} Approved Date: {{ $document->updated_at->format('F d,Y') }} Upload Date: {{$document->created_at->format('F d,Y')}}">{{ $document->updated_at->format('F d,Y') }}</span>
                                        </span>
                                    </div>
                                    <div class="col-md">
                                        <a class="btn btn-outline-info btn-sm rounded-pill btn-form-document mt-2"
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <span>
                                            ...
                                            <span role="button" data-bs-toggle="popover" data-trigger="focus"
                                                class="fw-bolder" title="VERIFICATION DETAILS"
                                                data-bs-content="Verified By: {{ $document->staff ? $document->staff->user->name : '-' }} Verified Date: {{ $document->updated_at->format('F d,Y') }} Upload Date: {{ $document->created_at->format('F d,Y') }}">{{ $document->feedback }}</span>
                                        </span>
                                    </div>
                                    <div class="col-md">
                                        <a class="btn btn-outline-info btn-sm rounded-pill btn-form-document mt-2"
                                ...
                                @if ($sent = $profile->sent_notification($item->id))
                                    <div class="row">
                                        ...
                                        <div class="col-md">
                                            ...
                                            <small
                                                class="badge bg-info">{{ $sent->updated_at->format('F d, Y') }}</small>
                                        </div>
                                    </div>
                                @endif
                            </div>
