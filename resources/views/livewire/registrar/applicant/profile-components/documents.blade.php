    ...
    <div class="card-body">
        ...
        <div class="mt-5">
            ...
            <form class="row" action="{{ route('document-verification') }}">
                ...
                <div class="col-md">
                    <a href="{{ route('document-verification') }}?_document={{ base64_encode($item->id) }}&_verification_status=1" class="mt-2 btn btn-outline-primary btn-sm rounded-pill " data-bs-toggle="tooltip" title="" data-bs-original-title="Approved Document">
                    ...
                    <a class="btn btn-outline-info btn-sm rounded-pill btn-form-document mt-2" data-bs-toggle="modal" data-bs-target=".document-view-modal" data-document-url="{{ json_decode($item->file_links)[0] }}" data-bs-toggle="tooltip" title="" data-bs-original-title="View Image">
                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="row mt-2">
                <div class="col-md-8">
                    ...
                    <span>
                        ...
                        <span role="button" data-bs-toggle="popover" data-trigger="focus" class="fw-bolder" title="APPROVED DETAILS" data-bs-content="Approved By: {{ $item->staff ? $item->staff->user->name : '-' }} Approved Date: {{ $item->created_at->format('F d,Y') }}">{{ $item->created_at->format('F d,Y') }}</span>
                    </span>
                </div>
                <div class="col-md">
                    <a class="btn btn-outline-info btn-sm rounded-pill btn-form-document mt-2 w-100" data-bs-toggle="modal" data-bs-target=".document-view-modal" data-document-url="{{ json_decode($item->file_links)[0] }}">
                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M15.1614 12.0531C15.1614 13.7991 13.7454 15.2141 11.9994 15.2141C10.2534 15.2141 8.83838 13.7991 8.83838 12.0531C8.83838 10.3061 10.2534 8.89111 11.9994 8.89111C13.7454 8.89111 15.1614 10.3061 15.1614 12.0531Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M11.998 19.355C15.806 19.355 19.289 16.617 21.25 12.053C19.289 7.48898 15.806 4.75098 11.998 4.75098H12.002C8.194 4.75098 4.711 7.48898 2.75 12.053C4.711 16.617 8.194 19.355 12.002 19.355H11.998Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
            ...
            <div class="row mt-2">
                <div class="col-md-8">
                    ...
                    <span>
                        <small>REMARKS: </small>
                        <span role="button" data-bs-toggle="popover" data-trigger="focus" class="fw-bolder" title="APPROVED DETAILS" data-bs-content="Approved By: {{ $item->staff ? $item->staff->user->name : '-' }} Approved Date: {{ $item->updated_at->format('F d,Y') }}">{{ $item->feedback }}</span>
                    </span>
                </div>
                <div class="col-md">
                    <a class="btn btn-outline-info btn-sm rounded-pill btn-form-document mt-2 w-100" data-bs-toggle="modal" data-bs-target=".document-view-modal" data-document-url="{{ json_decode($item->file_links)[0] }}" data-bs-toggle="tooltip" title="" data-bs-original-title="View Image">
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            ...
                            <small class="badge bg-info">{{ $sent->created_at->format('F d, Y') }}</small>
                        </div>
                    </div>
                    @endif
                ...
                <div class="col-md">
                    <a class="btn btn-outline-warning btn-sm rounded-pill btn-form-document mt-2" href="{{ route('document-notification') }}?_applicant={{ base64_encode($profile->id) }}&document={{ $docu->id }}" data-bs-toggle="tooltip" title="" data-bs-original-title="Send a Notification">
                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
