...
<div class="page-content">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4">
            <div class="row">
                <div class="col-12">
                    <a href="{{route('registrar.teacher-subject-loads')}}" class="btn btn-primary btn-sm w-100">TEACHER'S SUBJECT LOADS</a>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                        <select wire:model="selectCourse" class="form-select form-select-sm border border-primary" wire:change="">
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                        <select wire:model="selectCurriculum" class="form-select form-select-sm border border-primary" wire:change="">
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                        <form {{-- wire:submit.prevent="importTeachingLoad" --}} action="{{ route('registrar.subject-schedule-upload') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input class="form-control form-control-sm  border border-primary" type="file" name="upload-file">
