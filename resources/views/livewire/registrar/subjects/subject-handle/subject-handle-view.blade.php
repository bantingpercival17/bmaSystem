                        ...
                        <div class="row">
                            <div class="col-md">
                                <div class="form-group">
                                    <input class="form-control form-control-sm" type="file" id="customFile1" name="upload-file">
                                    <input type="hidden" name="curriculum" value="{{ $curriculum->id }}">
                                    <input type="hidden" name="course" value="{{ $_course->id }}">
                                    <input type="hidden" name="level" value="{{ Auth::user()->staff->convert_year_level($_level) }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md">
                                <a href="{{ route('registrar.subject-schedule-template') }}?course={{ base64_encode($_course->id) }}&data={{ base64_encode(json_encode([$curriculum->id, $_level, Auth::user()->staff->current_academic()->semester])) }}&section={{ base64_encode(json_encode([Auth::user()->staff->current_academic()->id, $_level])) }}" class="btn btn-info btn-sm text-white">SCHEDULE
                                    TEMPLATE</a>
                            </div>
                        </div>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-head-fixed text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('registrar.course-subject-handle-view') }}?_subject={{ base64_encode($subject->id) }}{{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}">
    ...
    <div class="col-lg-4 col-md-4">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="form-group">
                    <select wire:model="selectCourse" class="form-select form-select-sm border border-primary" wire:change="categoryCourse">
            ...
            <div class="col-12">
                ...
                <div class="form-group">
                    <select wire:model="selectCurriculum" class="form-select form-select-sm border border-primary" wire:change="categoryCurriculum">
            ...
            <div class="col-12">
                <small class="text-primary" data-toggle="tooltip" data-placement="right" title="You can use this Template to Bulk Upload the Teaching Loads and Schedules"><b>TEACHING
            ...
            <div class="col-12">
                <small class="text-primary" data-toggle="tooltip" data-placement="right" title="Upload the Template Excel File"><b>UPLOAD TEACHING LOAD</b> </small>
                <div class="form-group">
                    <form wire:submit.prevent="importTeachingLoad" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input class="form-control form-control-sm  border border-primary" type="file" wire:model="fileImport">
                            ...
                            <div class="col-md-12">
                                <button class="btn btn-info text-white btn-sm float-end" type="submit">UPLOAD</button>
                            </div>
