<div>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <a href="{{route('applicant.analytics')}}" class="float-end btn btn-primary btn-sm">Statistics</a>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th colspan="4" class="text-center fw-bolder text-primary">
                                <a target="_blank" href="{{ route($headers[2]) }}?category={{ str_replace(' ', '-', strtolower($headers[0])) }}{{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('applicant.overview') . '?_course=' . base64_encode($course->id) . '&_category=' . $item }}{{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}">
