...
@section('page-navigation')
    <ol class="breadcrumb ">
        ...
        <li class="breadcrumb-item"><a href="/registrar/subjects">Subject Handles</a></li>
        @if (request()->input('_d'))
            <li class="breadcrumb-item">
                <a href="/registrar/subjects/classes?_view={{ base64_encode($_academic->id) }}">
...
@endsection
@php
$_link_department = url()->current() . '?_view=' . request()->input('_view');
                                                            ...
                                                            <td colspan="5">
                                                                <div class="row">
                                                                        ...
                                                                        @foreach ($_subject->section($_academic->id)->get() as $_section)
                                                                            <div class="col-md-3">
                                                                                <div class="alert alert-secondary">
                                                                                    <a href="/registrar/subjects/classes/removed?_c={{ base64_encode($_section->id) }}"
                                                                                        class="close"><i
                                                                                            class="fa fa-times"></i></a>
                                                                                    <span
                                                                                        class="h6">{{ $_section->section->section_name }}</span>
                                                                                    <br>
                                                                                    <small>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <form action="/registrar/subjects/classes"
                                                                            class="callout callout-success" method="post">
                                                                            @csrf
                                                                            <input type="hidden" name="_subject"
                                                                                value="{{ $_subject->id }}">
                                                                            <input type="hidden" name="_curriculum"
                                                                                value="{{ $curriculum->id }}">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="form-group col">
                                                                                    <label for=""
                                                                                        class="text-muted">Teacher</label>
                                                                                ...
                                                                                <div class="form-group col">
                                                                                    <label for=""
                                                                                        class="text-muted">Section</label>
