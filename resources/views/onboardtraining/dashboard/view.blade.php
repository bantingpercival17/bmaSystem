...
@section('page-content')
    <div class="row">
        <div class="col-md">
            <a href="{{ route('onboard.embarked-list') }}">
                <div class="card  mb-xxl-0 iq-purchase" data-iq-gsap="onStart" data-iq-position-y="50" data-iq-rotate="0"
        ...
        <div class="col-md">
            <div class="card  mb-xxl-0 iq-purchase" data-iq-gsap="onStart" data-iq-position-y="50" data-iq-rotate="0"
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <h3 class="conter">{{ $_disembarked }}</h3>
                        {{-- <p class="mb-0 ms-2">+3 last/d</p> --}}
                    </div>
                </div>
            </div>
