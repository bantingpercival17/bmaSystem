...
@section('page-content')
    <div class=" mt-6 py-0">
        <form action="{{ route('exo.semestral-clearance-store') }}" method="post">
            @csrf
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="card-tool">
                        ...
                        <input type="hidden" name="_clearance_data" value="exo">
                                            ...
                                            <td>
                                                <div class="form-check d-block">
                                                    <input class="form-check-input input-select-subject-clearance"
                                                        ...
                                                        {{ $_data->student->non_academic_clearance('exo') ? ($_data->student->non_academic_clearance('exo')->is_approved == 1 ? 'checked' : '') : '' }}>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ $_data->student->non_academic_clearance('exo') ? $_data->student->non_academic_clearance('exo')->comments : '' }}">
