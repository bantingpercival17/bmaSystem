        ...
        @if (count($_sections) > 0)
            <div class="col-md-8">
                @foreach ($_sections as $_data)
                    <a
                        href="{{ route('exo.semestral-student-list') }}?_section={{ base64_encode($_data->id) }}{{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}">
                        <div class="card">
                            <div class="card-body">
        ...
        <div class="col-md">
            <div class="row">
                @foreach ($_courses as $course)
                    <div class="col-md">
                        <a href="{{ route('exo.semestral-clearance') . '?_course=' . base64_encode($course->id) }} {{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}"
                            class="">
