                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th>Section Name</th>
                                    <th>Midterm Grades Status</th>
                                    <th>Finals Grades Status</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if (count($course->sections))
                                    @foreach ($course->sections as $_key => $_data)
                                        <tr>
                                            <td>
                                                <a href="{{ route('dean.grade-verification-view') . '?_section=' . base64_encode($_data->id) }}&_academic={{ request()->input('_academic') }}"
                                                    class="">
                                                    {{ $_data->section_name }}
                                                </a>
