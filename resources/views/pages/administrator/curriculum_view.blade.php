                ...
                @else
                    @if ($_course_view->count() > 0)
                        @foreach ($_course_view as $data)
                            <div class="col-md-12">
                                <a
                                    href="{{ url()->current() }}?_c={{ request()->input('_c') }}&_d={{ Crypt::encrypt($data->id) }}">
                                    <div class="card card-primary ">
                                        <div class="card-body box-profile">
                                            <div class="">
                                                <h4 class="
                                                text-info">{{ $data->course_name }}</h4>
                                            </div>
        ...
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form role="form" action="/administrator/subjects" method="POST">
                        @csrf
                        <label for="" class="h5 text-success">SUBJECT DETAILS</label>
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    <input type="hidden" name="_input_" value="{{ request()->input('_d') }}">
                                    <input type="hidden" name="_input_0" value="{{ request()->input('_c') }}">
