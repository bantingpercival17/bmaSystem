...
@section('beardcrumb-content')
    @if (request()->input('_course'))
        <li class="breadcrumb-item active">
            <a
                href="{{ route('admin.semestral-clearance') }}{{ request()->input('_academic') ? '?_academic=' . request()->input('_academic') : '' }}">
        ...
        @if (count($_sections) > 0)
            <div class="col-md-8">
                @foreach ($_sections as $_data)
                    <a
                        href="{{ route('admin.semestral-student-list') }}?_section={{ base64_encode($_data->id) }}{{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}">
                        <div class="card">
                            <div class="card-body">
        ...
        <div class="col-md">
            <div class="row">
                @foreach ($_courses as $course)
                    <div class="col-md">
                        <a href="{{ route('admin.semestral-clearance') . '?_course=' . base64_encode($course->id) }} {{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}"
                            class="">
