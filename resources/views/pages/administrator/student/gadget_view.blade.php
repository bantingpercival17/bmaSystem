...
@section('js')
    <script>
        let card_layout = '<div class="card mb-2">' +
            ' <a><div class="row no-gutters"><div class="col-md-4">' +

            ' <img src="http://20.0.0.120/img/student-picture/midship-man.jpg" class="avatar-100 rounded card-img" alt="student-image">' +
            '</div><div class="col-md p-1"><div class="card-body p-2">' +
            '<small class="text-primary fw-bolder">STUDENT NAME</small> <br><small>COURSE</small>-<small>STUDENT NUMBER</small>' +
            '</div>/div></div> </a></div>'

        function card_layout_1(data) {
            ...
            /*   return '<div class="card mb-2">' +
                  ...
                  '<small class="text-primary fw-bolder">' + data.student.last_name.toUpperCase() + ", " + data.student
                  .first_name.toUpperCase() +
                  '</small> <br><small>COURSE</small>-<small>STUDENT NUMBER</small>' +
                  '</div>/div></div></a></div>' */
        }
