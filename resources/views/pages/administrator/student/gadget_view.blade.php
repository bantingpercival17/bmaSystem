...
@php
    $_title = 'Student Gadget Inventory';
@endphp
@section('page-title', 'Student Gadget Inventory')
    ...
    <div class="row mt-5">
        <div class="col-md-4">
            <form action="" method="get">
                <div class="col">
                    <small class="text-primary"><b>SEARCH</b></small>
                    ...
                    <div class="form-group">
                        <input type="search" class="form-control form-search"
                            placeholder="Search Pattern: Lastname, Firstname" name="search">
                    </div>

                </div>
            </form>
            <form action="{{ route('admin.student-gadget-import') }}" method="post" class="card"
                enctype="multipart/form-data">
                @csrf
                <div class="card-body  p-2 m-2">
                    <small class="text-muted fw-bolder">IMPORT GADGETS</small>
                    <div class="form-group">
                        <small class="text-success">ATTACH FILE</small>
                        <input type="file" class="form-control form-control-sm" name="files" required>
                    </div>
                    ...
                    <div class="card mb-2">
                        <a>
                            <div class="row no-gutters">
                                ...
                                <div class="col-md p-1">
                                    <div class="card-body p-2">
                                        <small class="text-primary fw-bolder">STUDENT NAME</small>
                                        <br>
                                        <small>COURSE</small>
                                        -
                                            ...
                                            <div class="col-xl col-md-6 ">
                                                <div class="form-group">
                                                    <label for="example-text-input" class="form-control-label">Middle
                                                        name</label>
                                                    <span
                                                        class="form-control">{{ ucwords($_student->middle_name) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-4 col-md-6 mb-xl-0">
                                                <div class="form-group">
                                                    <label for="example-text-input" class="form-control-label">Birth
                                                        Place</label>
                                                    <span
                                                        class="form-control">{{ ucwords($_student->birth_place) }}</span>
                                                </div>
                                            </div>
                                            <div class="col-xl-2 col-md-6 mb-xl-0">
                                                <div class="form-group">
                                                    <label for="example-text-input" class="form-control-label">Civil
                                                        Status</label>
                                                    <span
                                                        class="form-control">{{ ucwords($_student->civil_status) }}</span>
                                                </div>
                                            </div>
                                            <div class="col-xl-2 col-md-6 mb-xl-0">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-md-6 mb-xl-0">
                                                <div class="form-group">
                                                    ...
                                                    <span
                                                        class="form-control">{{ ucwords($_student->municipality) }}</span>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 mb-xl-0">
                                                <div class="form-group">
                                ...
                                <div class="card-body">
                                    ...
                                    @else
                                        <div class="enrollment-list row">
                                            <label for="" class="fw-bolder text-muted">NO ENROLLMENT
                                                DETIALS</label>
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="account-content">
                                        ...
                                        @else
                                            <div class="account-list row">
                                                <label for="" class="fw-bolder text-muted">NO STUDENT
                                                    ACCOUNT</label>
                                            </div>
                                        @endif
                                    </div>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title modal-title fw-bolder text-primary"
                                        id="model-add-accountTitle">ADD
                                        ACCOUNT
                                    </h5>
                                ...
                                <div class="modal-body">
                                    <form role="form" action="{{ route('admin.store-student-account') }}"
                                        method="POST" id="modal-form-add">
                                        @csrf
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            setInterval(() => {
                var input_search = $('.form-search').val();
                if (input_search != '') {
                    find_serial(input_search);
                }
            }, 1000);

        })
        /*   $(document).on('keydown', '.form-search', function() {
              var serial = $(this).val()
              $.get('gadget-finder?serial=' + $(this).val(), function(respond) {

                  console.log(serial)
                  $('.text-result').text("Result: " + serial)
                  $('.text-result-count').text(respond._gadget.length.toString())
                  $('.search-card').empty();
                  if (respond._gadget.length == 0) {
                      $('.search-card').append(layout_card(null));
                  } else {
                      respond._gadget.forEach(data => {
                          $('.search-card').append(layout_card(data));
                      });
                  }
                  $('.form-search').val('')
              }).fail(function() {
        ...
        function find_serial(serial) {
            var serial = serial
            $.get('gadget-finder?serial=' + serial, function(respond) {
                console.log(serial)
                $('.text-result').text("Result: " + serial)
                $('.text-result-count').text(respond._gadget.length.toString())
                $('.search-card').empty();
        ...
        function layout_card(data) {
            //var course = data.student.enrollment_assessment;
            var course = data ? data.student.enrollment_assessmen ? course.course_id == 1 ? 'BSMARE' : course.course_id ==
                2 ?
                'BSMT' : '-' : '' : '-';
            var student_name = data ? (data.student.last_name.toUpperCase() + ", " +
                data.student.first_name.toUpperCase()) : 'NO RESULT';
            var student_number = data ? data.student.account.student_number : "-";
            var serial = data ? data.gadget_serial : '-';
            return '<div class="card mb-2">' +
                '<div class="row no-gutters"> <div class="col-md-3">' +
                ' <img src="http://20.0.0.120/img/student-picture/midship-man.jpg"class="card-img" alt="#">' +
                '</div><div class="col-md ps-0"><div class="card-body p-3 me-2">' +
                '<label for=""  class="fw-bolder text-primary h4">' + student_name + '</label>' +
                '<p class="mb-0">' +
                ...
                '</small>' +
                '</p> <p class="mb-0">' +
                '<small class="fw-bolder text-muted">SERIAL NUMBER: </small>' +
                '<small class="fw-bolder badge bg-secondary">' +
                serial +
                '</small>' +
                '</p></div> </div></div></div>'
        ...
        function card_layout(data) {
            var course = data.student.enrollment_assessment;
            course = course ? course.course_id == 1 ? 'BSMARE' : course.course_id == 2 ? 'BSMT' : '-' : '';
            return '<div class="card mb-2">' +
                '<a><div class="row no-gutters">' +
                '<div class="col-md-4">' +
                ' <img src="http://20.0.0.120/img/student-picture/midship-man.jpg" class="avatar-100 rounded card-img" alt="student-image">' +
                '</div>' +
                '<div class="col-md p-1"><div class="card-body p-2">' +
                '<small class="text-primary fw-bolder">' + data.student.last_name.toUpperCase() + ", " + data.student
                .first_name.toUpperCase() +
                '</small> <br><small>' + course + '</small>-<small>' + data.student.account.student_number + '</small>' +
                '</div></div></div> </a></div>';
        }
    </script>
@endsection
