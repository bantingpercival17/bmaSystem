...
@section('page-content')
    <label for="" class="fw-bolder h3 text-primary">{{ $_course->course_name }}</label>
    <div class="row mt-5">
        <div class="col-md-8">
                           ...
                           {{--  <div class="col-md-3">
                            ...
                            <div class="col-md {{-- ps-0 --}}">
                                <div class="card-body p-3 me-2">
                                    <div class="float-end">
                                        <small
                                            class="badge bg-primary">{{ $_data->student->enrollment_status->created_at->format('F d, Y') }}</small>
                                    </div>
                                    <a
                                    ...
                                    <p class="mb-0">
                                        ...
                                        <small class="fw-bolder badge {{ $_course_color }}">
                                            {{ $_data ? ($_data->student->enrollment_status ? strtoupper($_data->student->enrollment_assessment->year_and_section($_data->student->enrollment_assessment)) : 'SECTION') : 'SECTION' }}
                                        </small>
                                    </p>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <h5 class="text-primary">
                                        @if ($_course->id == 3)
                                            Grade {{ $level }}
                                        @else
                                            {{ $_course->course_code . ' ' . strtoupper(Auth::user()->staff->convert_year_level($level)) }}
                                        @endif
                                    </h5>
