    ...
    <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between {{-- align-itmes-center --}}">
                                <div>
                                    <span><b>{{ $_data->student->account ? $_data->student->account->student_number : 'NEW STUDENT' }}</b></span>
                                    <a
                                    ...
                                    <span>WITH BRIDGING PROGRAM</span>
                                    <br>
                                    <span
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('registrar.student-information-report') }}?_assessment={{ base64_encode($_data->student->enrollment_assessment->id) }}"
                                        class="badge bg-info text-white"> <svg width="18" viewBox="0 0 24 24"
                        ...
                        <div class="card-footer">
                            @if ($_data->student->enrollment_assessment)
                                ...
                                @if ($_data->student->enrollment_assessment->bridging_payment)
                                    @if ($_data->student->enrollment_assessment->bridging_payment->is_approved === 1)
                                        <span class="badge bg-primary">For Payment Verified</span>
                                    @else
        ...
        <div class="col-md-4">
            ...
            @foreach ($_level as $level)
                <div class="col-md">
                    <a
                        href="{{ route('registrar.course-enrolled') }}?_course={{ base64_encode($_course->id) }}{{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}&_year_level={{ $level }}">
