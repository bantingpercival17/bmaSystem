                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between ">
                                <a
                                    href="{{ route('registrar.semestral-grade-view') }}?_section={{ base64_encode($_data->id) }}{{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}">
        ...
        <div class="col-md">
            <div class="row">
                @foreach ($_courses as $course)
                    <div class="col-md">
                        <a href="{{ route('registrar.semestral-grades') . '?_course=' . base64_encode($course->id) }}{{ request()->input('_academic') ? '&_academic=' . request()->input('_academic') : '' }}"
                            class="">
