...
@section('nav-items')
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-landing" role="button" aria-expanded="false"
            aria-controls="sidebar-landing">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.4"
        ...
        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-table" role="button" aria-expanded="false"
            ...
            <i class="icon">
                <svg width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M2 15H8V19H3C2.44772 19 2 18.5523 2 18V15Z" fill="#130F26" fill-opacity="0.4" />
                    <path d="M9 15H15V19H9V15Z" fill="#130F26" fill-opacity="0.4" />
                    <path d="M16 15H22V18C22 18.5523 21.5523 19 21 19H16V15Z" fill="#130F26" fill-opacity="0.4" />
                </svg>
            </i>
