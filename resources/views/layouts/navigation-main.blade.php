        ...
        <div class="container-fluid navbar-inner">
            ...
            <div class="input-group search-input">
                <span class="input-group-text" id="search-input">
                    <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <ellipse rx="9.10146" ry="8.88476" transform="matrix(-1 0 0 1 10.8985 9.88498)" stroke="#8A93AD"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M4.56836 16.5259L1.00007 20.0002" stroke="#8A93AD" stroke-width="2" stroke-linecap="round"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto top-menu navbar-nav align-items-center navbar-list mb-3 mb-lg-0">
                    <li class="nav-item">
                        <a href="../landing/index.html" class="nav-link ">Home</a>
                    </li>
                    <li class="dropdown nav-item mobile-menu">
                        ...
                        <ul class="dropdown-menu " data-popper-placement="bottom-start">
                            <!-- item-->
                            <li><a class="dropdown-item  " href="../landing/pricing-1.html">Pricing 1</a></li>
                            <!-- item-->
                            <li><a class="dropdown-item " href="../landing/pricing-2.html">Pricing 2</a></li>
                            <!-- item-->
                            <li><a class="dropdown-item " href="../landing/timeline.html">Timeline</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a href="../landing/invoice.html" class="nav-link ">Orders</a>
                    </li>
                    <li>
                        <ul class="m-0 d-flex align-items-center navbar-list list-unstyled px-3 px-md-0">
                            <li class="nav-item dropdown ms-0 ms-md-5 me-2">
                                <a href="#" class="nav-link" id="mail-drop" data-bs-toggle="dropdown"
                                    ...
                                    <svg width="24" viewBox="0 0 30 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M22.8705 8.80127L16.9461 13.6187C15.8267 14.5067 14.2519 14.5067 13.1326 13.6187L7.1582 8.80127"
                                            stroke="#8A93AD" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M21.5445 24.9999C25.5996 25.0112 28.3327 21.6794 28.3327 17.5845V8.42668C28.3327 4.33177 25.5996 1 21.5445 1H8.4542C4.39906 1 1.66602 4.33177 1.66602 8.42668V17.5845C1.66602 21.6794 4.39906 25.0112 8.4542 24.9999H21.5445Z"
                                            stroke="#8A93AD" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                        ...
                                        <div class="card-body p-0 ">
                                                ...
                                                <div class="d-flex  align-items-center">
                                                    <div class="">
                                                        <img class="avatar-40 rounded-pill bg-soft-primary p-1"
                                                            src="../assets/images/icons/03.png" alt="">
                                                    </div>
                                                    <div class="ms-3">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <div class="">
                                                        <img class="avatar-40 rounded-pill bg-soft-primary p-1"
                                                            src="../assets/images/avatars/04.png" alt="">
                                                    </div>
                                                    <div class="ms-3">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <div class="">
                                                        <img class="avatar-40 rounded-pill bg-soft-primary p-1"
                                                            src="../assets/images/icons/02.png" alt="">
                                                    </div>
                                                    <div class="ms-3">
                            ...
                            <li class="dropdown">
                                <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown3"
                                    role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="../assets/images/avatars/01.png" alt="User-Profile"
                                        class="img-fluid avatar avatar-50 avatar-rounded">
                                </a>
                                <ul class="dropdown-menu  dropdown-menu-lg-end" aria-labelledby="navbarDropdown3">
                                    <li><a class="dropdown-item" href="../dashboard/app/user-profile.html">My
                                            Profile</a></li>
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-landing" role="button"
                            aria-expanded="false" aria-controls="sidebar-landing">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                            ...
                            <span class="item-name">Landing Pages</span>
                            <i class="right-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <ul class="sub-nav collapse" id="sidebar-landing" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="../landing/index.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="../landing/product.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                        ...
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-table" role="button"
                            ...
                            <i class="icon">
                                <svg width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M2 6C2 5.44772 2.44772 5 3 5H8V9H2V6Z" fill="#130F26" />
                                    <path d="M9 5H15V9H9V5Z" fill="#130F26" />
                                    <path d="M16 5H21C21.5523 5 22 5.44772 22 6V9H16V5Z" fill="#130F26" />
                                    <path d="M2 10H8V14H2V10Z" fill="#130F26" fill-opacity="0.4" />
                                    <path d="M9 10H15V14H9V10Z" fill="#130F26" fill-opacity="0.4" />
                                    <path d="M16 10H22V14H16V10Z" fill="#130F26" fill-opacity="0.4" />
                                    <path d="M2 15H8V19H3C2.44772 19 2 18.5523 2 18V15Z" fill="#130F26"
                                        fill-opacity="0.4" />
                                    <path d="M9 15H15V19H9V15Z" fill="#130F26" fill-opacity="0.4" />
                                    <path d="M16 15H22V18C22 18.5523 21.5523 19 21 19H16V15Z" fill="#130F26"
                                        fill-opacity="0.4" />
                                </svg>
                            </i>
                ...
                <div class="card bg-primary text-white text-center iq-post m-3">
                    <div class="card-body">
                        ...
                        <div class="border rounded-3 mb-3 mx-4">
                            <img src="../assets/images/layouts/user-dashboard/12.png" class="img-fluid avatar-130"
                                alt="image">
                        </div>
                        <p class="text-white mb-5">Gigz posted successfully</p>
