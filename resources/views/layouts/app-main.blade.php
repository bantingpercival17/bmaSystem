...
<body class=" ">
    ...
    @if (Auth::user())
        ...
        <main class="main-content">
            ...
            @else
                @php
                    $_route = ['registrar/dashboard*', 'registrar/enrollment*', 'registrar/semestral-clearance*', 'teacher/subjects*', 'department-head/grade-submission*', 'department-head/semestral-clearance*', 'dean/e-clearance*', 'accounting/fees*', 'accounting/particular/fee*', 'accounting/semestral-clearance*', 'executive/semestral-clearance*', 'librarian/semestral-clearance*'];
                @endphp
